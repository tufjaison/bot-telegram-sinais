...
async def consultar(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Se a API retornar erro HTTP (ex: 429 Too Many Requests, 401 Unauthorized)
        ...
        # Manda no Telegram exatamente as chaves que a API retornou para debug
        chaves_retornadas = list(data.keys()) if isinstance(data, dict) else type(data)
        
        # Tenta capturar a lista de jogos
        jogos_encontrados = []
